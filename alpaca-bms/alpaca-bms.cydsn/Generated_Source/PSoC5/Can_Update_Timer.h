...
#define Can_Update_Timer_Resolution                 8u
...
uint8  Can_Update_Timer_ReadPeriod(void) ;
void    Can_Update_Timer_WritePeriod(uint8 period) ;
uint8  Can_Update_Timer_ReadCounter(void) ;
void    Can_Update_Timer_WriteCounter(uint8 counter) ;
uint8  Can_Update_Timer_ReadCapture(void) ;
...
#define Can_Update_Timer_INIT_PERIOD             255u
...
***************************************/
    ...
    ***************************************/
    ...
    #define Can_Update_Timer_CONTROL             (* (reg8 *) Can_Update_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Can_Update_Timer_CAPTURE_LSB         (* (reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Can_Update_Timer_CAPTURE_LSB_PTR       ((reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Can_Update_Timer_PERIOD_LSB          (* (reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Can_Update_Timer_PERIOD_LSB_PTR        ((reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Can_Update_Timer_COUNTER_LSB         (* (reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
        #define Can_Update_Timer_COUNTER_LSB_PTR       ((reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
    #elif(Can_Update_Timer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Can_Update_Timer_CAPTURE_LSB         (* (reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__F0_REG )
            #define Can_Update_Timer_CAPTURE_LSB_PTR       ((reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__F0_REG )
            #define Can_Update_Timer_PERIOD_LSB          (* (reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__D0_REG )
            #define Can_Update_Timer_PERIOD_LSB_PTR        ((reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__D0_REG )
            #define Can_Update_Timer_COUNTER_LSB         (* (reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
            #define Can_Update_Timer_COUNTER_LSB_PTR       ((reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Can_Update_Timer_CAPTURE_LSB         (* (reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG )
            #define Can_Update_Timer_CAPTURE_LSB_PTR       ((reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG )
            #define Can_Update_Timer_PERIOD_LSB          (* (reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG )
            #define Can_Update_Timer_PERIOD_LSB_PTR        ((reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG )
            #define Can_Update_Timer_COUNTER_LSB         (* (reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG )
            #define Can_Update_Timer_COUNTER_LSB_PTR       ((reg16 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Can_Update_Timer_Resolution <= 24u)/* 24-bit Timer */
        #define Can_Update_Timer_CAPTURE_LSB         (* (reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Can_Update_Timer_CAPTURE_LSB_PTR       ((reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Can_Update_Timer_PERIOD_LSB          (* (reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Can_Update_Timer_PERIOD_LSB_PTR        ((reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Can_Update_Timer_COUNTER_LSB         (* (reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
        #define Can_Update_Timer_COUNTER_LSB_PTR       ((reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Can_Update_Timer_CAPTURE_LSB         (* (reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__32BIT_F0_REG )
            #define Can_Update_Timer_CAPTURE_LSB_PTR       ((reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__32BIT_F0_REG )
            #define Can_Update_Timer_PERIOD_LSB          (* (reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__32BIT_D0_REG )
            #define Can_Update_Timer_PERIOD_LSB_PTR        ((reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__32BIT_D0_REG )
            #define Can_Update_Timer_COUNTER_LSB         (* (reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__32BIT_A0_REG )
            #define Can_Update_Timer_COUNTER_LSB_PTR       ((reg32 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Can_Update_Timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) Can_Update_Timer_TimerUDB_sT8_timerdp_u0__A0_REG )
